...
<!-- Placed at the end of the document so the pages load faster ============================================= -->
	<script src="asset<?php echo e(('themes/js/jquery.js')); ?>" type="text/javascript"></script>
	<script src="asset<?php echo e(('themes/js/bootstrap.min.js')); ?>" type="text/javascript"></script>
	<script src="asset<?php echo e(('themes/js/google-code-prettify/prettify.js')); ?>"></script>
	
	<script src="asset<?php echo e(('themes/js/bootshop.js')); ?>"></script>
    <script src="asset<?php echo e(('themes/js/jquery.lightbox-0.5.js')); ?>"></script>
	
</body>
</html><?php /**PATH D:\laravelEcommerce\demo\resources\views/front/layout/layout2.blade.php ENDPATH**/ ?>